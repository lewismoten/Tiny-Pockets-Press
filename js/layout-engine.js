...
TPP.settings = function () {
  ...
  return Object.assign({}, book, {
    ...
    backText: TPP.backCoverInfo(book).text,
    backTextY: TPP.backCoverInfo(book).textY,
    backTextSize: TPP.backCoverInfo(book).textSize,
    backTextColor: TPP.backCoverInfo(book).textColor,
    backTextAlign: TPP.backCoverInfo(book).textAlign,
    ...
    backImgX: TPP.backCoverInfo(book).imgX,
    backImgY: TPP.backCoverInfo(book).imgY,
    backImgZoom: TPP.backCoverInfo(book).imgZoom,
    backImgRotate: TPP.backCoverInfo(book).imgRotate,
    spineImgX: TPP.spineInfo(book).imgX,
    spineImgY: TPP.spineInfo(book).imgY,
    spineImgZoom: TPP.spineInfo(book).imgZoom,
    spineImgRotate: TPP.spineInfo(book).imgRotate,
    spineTitleSize: TPP.spineInfo(book).titleSize,
    spineTitleX: TPP.spineInfo(book).titleX,
    spineTitleY: TPP.spineInfo(book).titleY,
    spineTitleWidth: TPP.spineInfo(book).titleWidth,
    spineTitleAlign: TPP.spineInfo(book).titleAlign,
    spineAuthorSize: TPP.spineInfo(book).authorSize,
    spineTextColor: TPP.spineInfo(book).textColor,
    spineStroke: TPP.spineInfo(book).stroke,
    spineStrokeColor: TPP.spineInfo(book).strokeColor,
    spineStrokeSize: TPP.spineInfo(book).strokeSize,
    spineTitleRotate: TPP.spineInfo(book).titleRotate,
    spineAuthorOn: TPP.spineInfo(book).authorOn,
    spineAuthorRotate: TPP.spineInfo(book).authorRotate,
